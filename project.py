...
aio = Client('aervabhargavi', 'aio_jpcN97lWUNGYOcYAqlg6pb0S7Inh')

# Send the value 1 to a feed called 'Foo'.
aio.send('bedroom-slash-light',1)
aio.send('fan',1)
...
data1 = aio.receive('bedroom-slash-light')
...
def main(bot,update):
  ...
  if a =="turn on light" or a=="light on":
    ...
    BOT_TOKEN = '1941371946:AAEqtGeZOzBHBcAEWP3UjwGmjF5qzJ2puHI'
